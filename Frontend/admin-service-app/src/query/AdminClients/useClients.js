...
export const getActiveClients = ()=>axiosInstance.get("/admin/clients").then((res)=>res.data)

//function to get banned clients
export const getBannedClients = ()=>axiosInstance.get("/admin/clients/banned").then((res)=>res.data)
